...
| Global `previewThemes` dropdown in the header (`index.ts` config) | every section; `html.theme-*` hooks in 1.1 |
| Theme delivered as its own stylesheet (`previewThemes[].css`) | Forest, `themes/forest.css` (not imported by `styles.css`) |
